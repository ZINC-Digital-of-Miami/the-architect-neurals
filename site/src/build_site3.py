...
rail_stops = [
 ("AUG 18","Comey E.D.N.C. responses due; Missouri referendum hearing",""),
 ("AUG 19","AIFC Q2 10-Q — post-unlock WLFI marks",""),
 ("AUG 21","White House ballroom: D.C. Circuit self-stay expires",""),
 ("AUG 23","Phang v. Blanche: proposed compliance orders; contempt watch",""),
 ("AUG 31","ICE “Mega Hub” bid deadline — up to $10B",""),
 ("SEP 8","Missouri ballot-print deadline",""),
 ("SEP 14","Congress returns — SAVE Act redux; war powers",""),
