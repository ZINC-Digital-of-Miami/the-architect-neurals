...
<div class="share-actions"><button type="button" data-share-copy>Copy link</button><button type="button" data-share-native hidden>Share via…</button><button type="button" data-share-pdf aria-label="Print or save as PDF">PDF</button></div>
