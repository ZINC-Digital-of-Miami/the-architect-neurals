...
<div class="share-actions"><button type="button" data-share-copy>Copy link</button><button type="button" data-share-native hidden>Share via…</button><button type="button" data-ui-print>Print page</button></div>
